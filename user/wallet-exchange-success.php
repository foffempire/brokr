  ...
  <div class="col-xl-12">
    <div class="site-card">
      ...
      <div class="site-card-body">
        ...
        <div class='alert alert-success alert-dismissible fade show' role='alert'>Exchange successful! <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button> </div>
