...
<div class="panel-layout">
    ...
    <div class="logo">
        <a href="./dashboard">
            <img class="logo-unfold" src="../assets/global/images/hH42szx7wOd36BuyKWHJ.png" alt="Logo"/>
            <img class="logo-fold" src="../assets/global/images/hH42szx7wOd36BuyKWHJ.png" alt="Logo"/>
        </a>
    </div>
    <div class="nav-wrap">
        <div class="nav-left">
        ...
        <div class="nav-right">
            <div class="single-nav-right">
                <a href="./dashboard" class="user-home-menu">
